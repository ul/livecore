...
proc fsw_init_session*(monitor_type: cint): ptr fsw_handle {.importc,
    dynlib: libName.}

proc fsw_add_path*(handle: ptr fsw_handle, path: cstring): cint {.importc,
    dynlib: libName.}

proc fsw_add_property*(handle: ptr fsw_handle, name: string,
    value: string): cint {.importc, dynlib: libName.}

proc fsw_set_allow_overflow*(handle: ptr fsw_handle,
    allow_overflow: bool): cint {.importc, dynlib: libName.}

proc fsw_set_callback*(handle: ptr fsw_handle, callback: proc(
    events: fsw_cevent, event_num: cuint)): cint {.importc, dynlib: libName.}

proc fsw_set_latency*(handle: ptr fsw_handle, latency: cdouble): cint {.importc,
    dynlib: libName.}

proc fsw_set_recursive*(handle: ptr fsw_handle,
    recursive: bool): cint {.importc, dynlib: libName.}

proc fsw_set_directory_only*(handle: ptr fsw_handle,
    directory_only: bool): cint {.importc, dynlib: libName.}

proc fsw_set_follow_symlinks*(handle: ptr fsw_handle,
    follow_symlinks: bool): cint {.importc, dynlib: libName.}

proc fsw_add_event_type_filter*(handle: ptr fsw_handle,
    event_type: fsw_event_type_filter): cint {.importc, dynlib: libName.}

proc fsw_add_filter*(handle: ptr fsw_handle,
    filter: fsw_cmonitor_filter): cint {.importc, dynlib: libName.}

proc fsw_start_monitor*(handle: ptr fsw_handle): cint {.importc,
    dynlib: libName.}

proc fsw_stop_monitor*(handle: ptr fsw_handle): cint {.importc,
    dynlib: libName.}

proc fsw_is_running*(handle: ptr fsw_handle): bool {.importc, dynlib: libName.}

proc fsw_destroy_session*(handle: ptr fsw_handle): cint {.importc,
    dynlib: libName.}
